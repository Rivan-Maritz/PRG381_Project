 ...
 * @author tii6t
 */
public class SuppliersManagements extends javax.swing.JFrame {
    
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(SuppliersManagements.class.getName());

    /**
     * Creates new form SuppliersManagements
     */
    public SuppliersManagements() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new SuppliersManagements().setVisible(true));
    }
